exp_name = 'caps/carla/coll_speed/dql'
seed = 0
log_level = 'debug'
...
env_params = {
    'class': CarlaCollSpeedEnv,
    'kwargs': {
        'run_headless': False,
        'gpu': 0,
        'port': 2060,
        'weather': 2, # cloudy noon
        'player_start_indices': None,
        'number_of_pedestrians': 150,
        'run_server': True
    }
}

env_eval_params = None # if None, env_eval = env
...
alg_params = {
    ...
    'kwargs': {
        ...
        'save_every_n_steps': 2.5e+3, # how often to save experiment data
        'save_async': True, # save files in the background?
